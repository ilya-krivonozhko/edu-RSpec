...
Этот репозиторий содержит моё прохождение [курса по **RSpec**](https://youtube.com/playlist?list=PLWlFXymvoaJ8BVBVvscCO5yG96gkmsZzK).
...
This repository contains my progress through an [**RSpec** course](https://youtube.com/playlist?list=PLWlFXymvoaJ8BVBVvscCO5yG96gkmsZzK).
